...
public class Panel extends JFrame {
	...
	public Panel() {
		...
		JTextField TextFname = new JTextField("Hello World", 15);
		JTextField TextLname = new JTextField("Hello World", 15);
		JTextField TextPosition = new JTextField("Hello World", 15);
		JTextField TextArrived = new JTextField("Hello World", 15);
